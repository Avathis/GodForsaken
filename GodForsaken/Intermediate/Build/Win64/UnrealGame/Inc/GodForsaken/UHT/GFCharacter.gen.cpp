...
// End Cross Module References
	DEFINE_FUNCTION(AGFCharacter::execGetMaxPoise)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(float*)Z_Param__Result=P_THIS->GetMaxPoise();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AGFCharacter::execGetPoise)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(float*)Z_Param__Result=P_THIS->GetPoise();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(AGFCharacter::execGetPoisePercentage)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(float*)Z_Param__Result=P_THIS->GetPoisePercentage();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(AGFCharacter::execFinalizeDeath)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->FinalizeDeath();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AGFCharacter::execInitiateDeath)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->InitiateDeath();
		P_NATIVE_END;
	}
	...
	void AGFCharacter::StaticRegisterNativesAGFCharacter()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "FinalizeDeath", &AGFCharacter::execFinalizeDeath },
			...
			{ "GetMaxPoise", &AGFCharacter::execGetMaxPoise },
			...
			{ "GetPoise", &AGFCharacter::execGetPoise },
			{ "GetPoisePercentage", &AGFCharacter::execGetPoisePercentage },
			...
			{ "InitiateDeath", &AGFCharacter::execInitiateDeath },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AGFCharacter_FinalizeDeath_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AGFCharacter_FinalizeDeath_Statics::Function_MetaDataParams[] = {
		{ "Category", "Attributes" },
		{ "ModuleRelativePath", "Public/BaseClasses/Characters/GFCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGFCharacter_FinalizeDeath_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGFCharacter, nullptr, "FinalizeDeath", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_FinalizeDeath_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGFCharacter_FinalizeDeath_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_AGFCharacter_FinalizeDeath()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AGFCharacter_FinalizeDeath_Statics::FuncParams);
		}
	...
	struct Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics
	{
		struct GFCharacter_eventGetMaxPoise_Parms
		{
			float ReturnValue;
		};
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ReturnValue;
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GFCharacter_eventGetMaxPoise_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::Function_MetaDataParams[] = {
		{ "Category", "Attributes" },
		{ "ModuleRelativePath", "Public/BaseClasses/Characters/GFCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGFCharacter, nullptr, "GetMaxPoise", nullptr, nullptr, Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::PropPointers), sizeof(Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::GFCharacter_eventGetMaxPoise_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::GFCharacter_eventGetMaxPoise_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AGFCharacter_GetMaxPoise()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AGFCharacter_GetMaxPoise_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AGFCharacter_GetPoise_Statics
	{
		struct GFCharacter_eventGetPoise_Parms
		{
			float ReturnValue;
		};
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ReturnValue;
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GFCharacter_eventGetPoise_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::Function_MetaDataParams[] = {
		{ "Category", "Attributes" },
		{ "ModuleRelativePath", "Public/BaseClasses/Characters/GFCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGFCharacter, nullptr, "GetPoise", nullptr, nullptr, Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::PropPointers), sizeof(Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::GFCharacter_eventGetPoise_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::GFCharacter_eventGetPoise_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AGFCharacter_GetPoise()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AGFCharacter_GetPoise_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics
	{
		struct GFCharacter_eventGetPoisePercentage_Parms
		{
			float ReturnValue;
		};
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ReturnValue;
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GFCharacter_eventGetPoisePercentage_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::Function_MetaDataParams[] = {
		{ "Category", "Attributes" },
		{ "ModuleRelativePath", "Public/BaseClasses/Characters/GFCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGFCharacter, nullptr, "GetPoisePercentage", nullptr, nullptr, Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::PropPointers), sizeof(Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::GFCharacter_eventGetPoisePercentage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::GFCharacter_eventGetPoisePercentage_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AGFCharacter_GetPoisePercentage()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AGFCharacter_GetPoisePercentage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AGFCharacter_InitiateDeath_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AGFCharacter_InitiateDeath_Statics::Function_MetaDataParams[] = {
		{ "Category", "Attributes" },
		{ "ModuleRelativePath", "Public/BaseClasses/Characters/GFCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AGFCharacter_InitiateDeath_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AGFCharacter, nullptr, "InitiateDeath", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AGFCharacter_InitiateDeath_Statics::Function_MetaDataParams), Z_Construct_UFunction_AGFCharacter_InitiateDeath_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_AGFCharacter_InitiateDeath()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AGFCharacter_InitiateDeath_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TimeToDie_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_TimeToDie;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AGFCharacter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AGFCharacter_FinalizeDeath, "FinalizeDeath" }, // 2237363681
		...
		{ &Z_Construct_UFunction_AGFCharacter_GetMaxPoise, "GetMaxPoise" }, // 524325382
		...
		{ &Z_Construct_UFunction_AGFCharacter_GetPoise, "GetPoise" }, // 1471312962
		{ &Z_Construct_UFunction_AGFCharacter_GetPoisePercentage, "GetPoisePercentage" }, // 1426069468
		...
		{ &Z_Construct_UFunction_AGFCharacter_InitiateDeath, "InitiateDeath" }, // 1272334814
	};
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGFCharacter_Statics::NewProp_TimeToDie_MetaData[] = {
		{ "Category", "GFCharacter" },
		{ "ModuleRelativePath", "Public/BaseClasses/Characters/GFCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AGFCharacter_Statics::NewProp_TimeToDie = { "TimeToDie", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGFCharacter, TimeToDie), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AGFCharacter_Statics::NewProp_TimeToDie_MetaData), Z_Construct_UClass_AGFCharacter_Statics::NewProp_TimeToDie_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGFCharacter_Statics::NewProp_CharacterStatusBar_MetaData[] = {
		{ "Category", "Components" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//virtual void GetOwnedGameplayTags(FGameplayTagContainer& TagContainer) const override;\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/BaseClasses/Characters/GFCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "virtual void GetOwnedGameplayTags(FGameplayTagContainer& TagContainer) const override;" },
#endif
	};
#endif
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGFCharacter_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGFCharacter_Statics::NewProp_TimeToDie,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameProjects_GodForsaken_GodForsaken_Source_GodForsaken_Public_BaseClasses_Characters_GFCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGFCharacter, AGFCharacter::StaticClass, TEXT("AGFCharacter"), &Z_Registration_Info_UClass_AGFCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGFCharacter), 568089728U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameProjects_GodForsaken_GodForsaken_Source_GodForsaken_Public_BaseClasses_Characters_GFCharacter_h_3013502205(TEXT("/Script/GodForsaken"),
